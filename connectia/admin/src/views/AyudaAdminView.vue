...
.btn-ghost.on { background: color-mix(in srgb, var(--primary, var(--brand-primary)) 12%, var(--panel)); border-color: var(--primary, var(--brand-primary)); color: var(--primary, var(--brand-primary)); }

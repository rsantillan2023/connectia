...
export const GENERIC_MENU = [
  ...
  { key: 'servicios', label: 'Servicios', route: '/servicios', icon: 'grid', order: 56, channel: 'u' },
  ...
  { key: 'admin.servicios', label: 'Gestión de servicios', route: '/servicios', icon: 'grid', order: 49, channel: 'a' },
